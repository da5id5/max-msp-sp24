...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 408.0, 530.0, 208.0, 113.0 ],
					"prototypename" : "pixl",
					"varname" : "analyzr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 650.0, 636.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 817.0, 576.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 956.0, 576.0, 126.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1053.0, 470.0, 117.5, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1053.0, 371.0, 280.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1240.0, 470.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 911.0, 552.0, 216.0, 23.0 ],
					"text" : "noteout 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.0, 407.0, 37.0, 23.0 ],
					"text" : "60 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 911.0, 374.0, 45.0, 23.0 ],
					"text" : "60 80"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 961.0, 371.0, 73.0, 25.0 ],
					"text" : "note-on"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 966.0, 404.0, 73.0, 25.0 ],
					"text" : "note-off"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1127.0, 552.0, 188.37701416015625, 84.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 491.0, 32.0, 22.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 824.0, 735.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 788.0, 535.0, 69.0, 22.0 ],
					"text" : "rect~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 35.0, 185.0, 348.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "playr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 749.0, 170.0, 108.0, 78.0 ],
					"prototypename" : "pixl",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 650.0, 12.0, 214.0, 116.0 ],
					"varname" : "bp.CV LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 416.0, 21.0, 206.0, 186.0 ],
					"prototypename" : "pixl",
					"varname" : "attractr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-20::obj-7" : [ "Random", "textbutton[1]", 0 ],
			...
			"obj-2::obj-46" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			"obj-2::obj-48" : [ "Green mode", "Green mode", 0 ],
			"obj-2::obj-50" : [ "pictctrl[10]", "pictctrl[1]", 0 ],
			"obj-2::obj-54" : [ "Blue mode", "Blue mode", 0 ],
			"obj-2::obj-58" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			...
			"obj-6::obj-10" : [ "pictctrl[94]", "pictctrl[1]", 0 ],
			...
			"obj-6::obj-20" : [ "pictctrl[96]", "pictctrl[1]", 0 ],
...
,
				"obj-1::obj-94" : 				{
					...
					"parameter_shortname" : "multiplier2"
				}
,
				"obj-20::obj-127" : 				{
